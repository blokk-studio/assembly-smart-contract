...
contract MockERC1155CreatorExtensionBurnable is
    ...
    ERC1155CreatorExtensionBurnable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(CreatorExtensionBasic, ERC1155CreatorExtensionBurnable)
        returns (bool)
    {
        return
            CreatorExtensionBasic.supportsInterface(interfaceId) ||
            ERC1155CreatorExtensionBurnable.supportsInterface(interfaceId);
    }
    ...
    function testMintExisting(
        address[] calldata to,
        uint256[] calldata tokenIds,
        uint256[] calldata amounts
    ) external {
        IERC1155CreatorCore(_creator).mintExtensionExisting(
            to,
            tokenIds,
            amounts
        );
