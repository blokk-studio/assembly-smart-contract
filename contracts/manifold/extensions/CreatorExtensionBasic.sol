 ...
 */
abstract contract CreatorExtensionBasic is
    AdminControl,
    CreatorExtension,
    ICreatorExtensionBasic
{
     ...
     */
    function setBaseTokenURI(address creator, string calldata uri)
        external
        override
        adminRequired
    {
     ...
     */
    function setTokenURIPrefix(address creator, string calldata prefix)
        external
        override
        adminRequired
    {
